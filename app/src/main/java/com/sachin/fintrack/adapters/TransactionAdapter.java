...
public class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.TransactionViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TransactionViewHolder holder, int position) {
        ...
        // --- FIXED LOGIC: ONLY SHOW NOTES IN 'NOTES' TAB (Index 4) ---
        if (Constants.SELECTED_TAB == 4 && transaction.getNote() != null && !transaction.getNote().isEmpty()) {
            holder.binding.transactionNote.setText(transaction.getNote());
            holder.binding.transactionNote.setVisibility(View.VISIBLE);
        } else {
            // Daily, Monthly, Calendar tabs mein notes hide rahenge
            holder.binding.transactionNote.setVisibility(View.GONE);
        }
        // -------------------------------------------------------
